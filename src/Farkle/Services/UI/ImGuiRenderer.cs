...
public class ImGuiRenderer : IDisposable
{
    ...
    private readonly GuiFontProvider _fontProvider;
    ...
    private nint _implotContext;
    
    public ImGuiRenderer(GameMain game)
    {
        ArgumentNullException.ThrowIfNull(game);

        _game = game;
        _fontProvider = game.Services.GetService<GuiFontProvider>();
    ...
    protected virtual void UpdateInput()
    {
        ...
        io.AddMouseWheelEvent(
            wheel_x: 0,
            wheel_y: -mouse.DeltaScrollWheelValue / WHEEL_DELTA
        );
